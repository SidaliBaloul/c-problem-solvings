...
int DaysUntilEndOfMonth(sDate date)
{
	...
	return GetDifferenceDays(date, date2,true);
}
...
int main()
{
	...
	cout << "Today is : " << DayShortName(DayOfWeekOrder(date)) << endl << endl;
	...
	cout << "Number of days until end of week is  : " << DaysUntilEndOfWeek(date) << endl;
	cout << "Number of days until end of month is : " << DaysUntilEndOfMonth(date) << endl;
	cout << "Number of days until end of year is  : " << DaysUntilEndOfYear(date) << endl;
