...
int PeriodeLength(sPeriode periode1, bool day = false)
{
	return GetDifferenceDays(periode1.startdate, periode1.enddate, day);
}
...
int main()
{
	...
	cout << "Periode length is : " << PeriodeLength(periode1) << endl;
	cout << "Periode length including end day is : " << PeriodeLength(periode1,true) << endl;
